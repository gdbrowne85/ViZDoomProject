...
from convolution_demo import CDQN
...
if __name__ == "__main__":
    ...
    for episode in range(num_episodes):
        ...
        # Decay epsilon after each episode
            ...
            if episode % 10 == 0 and episode_steps == 499:
            # Save both raw screen buffer and filter output
                print('saving output')
                dqn_agent.save_visualizations(state, episode)
