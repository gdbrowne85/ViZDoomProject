...
class DoomEnv:
    ...
    def step(self, action_index):
        ...
        if not done:
            ...
            position_change_bonus = variable_changes[2] / 10  # Change in POSITION_X encourages movement

            # Aggregate reward
            reward = variable_changes[2] # rewarded for positive change in X position
...
if __name__ == "__main__":
    # Initialize DoomGame
    game = vzd.DoomGame()
    #level_path = "my_way_home.cfg"  # Update this to the actual configuration file path
    ...
    game_variables = [vzd.GameVariable.AMMO2, vzd.GameVariable.HEALTH, vzd.GameVariable.POSITION_X]
